...
return array(
    ...
    'fieldName.username2' => '用户名2',
    'validationRule.systemRule.require2' => '名称不能为空',
    'ruleName.rule3' => '规则名rule3',
    'fieldName.name3' => '姓名',
    'validationRule.systemRule.require3' => '名称不能为空',
    'validationRule.systemRule.number3' => '必须为数字',
    'validationRule.systemRule.max3' => '最大值为12',
    'validationRule.systemRule.min3' => '最小值为4',
    'ruleName.rule4' => '规则名rule4',
    'fieldName.test4' => '测试',
    'validationRule.systemRule.require4' => '测试不能为空'
);
